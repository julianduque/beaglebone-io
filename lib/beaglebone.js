...
BeagleBone.prototype.sendI2CConfig = function() {
  if (i2c1 === undefined) {
    i2c1 = i2c.openSync(1, function(err) {
      if (err) {
        throw new Error("I2COpen Error = " + err);
      }
    });
  }
  return this;
...
BeagleBone.prototype.sendI2CWriteRequest = function(address, bytes) {
  ...
  i2c1.i2cWrite(address, i2cBuffer.length, i2cBuffer, function(i2cError, i2cNumBytes, i2cBuffer) {
    if (i2cError) {
      throw new Error('I2CWrite Error = ' + i2cError + " Number of Bytes = " + i2cNumBytes + "Buffer = " + i2cBuffer);
    }
  });
  return this;
};
...
BeagleBone.prototype.sendI2CReadRequest = function(address, length, cb) {
  i2c1.i2cRead(address, length, i2cBuffer, function(i2cError, i2cNumBytes, i2cBuffer) {
    if (i2cError) {
      throw new Error("I2CRead Error = " + i2cError + " Number of Bytes = " + i2cNumBytes + "Buffer = " + i2cBuffer);
    }
    cb(i2cBuffer);
